ig.module(
    ...
    EntityZombie = ig.Entity.extend({
        ...
        init: function(x, y, settings) {
            ...
            this.zombieType = Math.floor(Math.random()*7);
            var offset = this.zombieType*7;
            this.health += this.zombieType*10;
            // Animation
        ...
        receiveDamage: function(amount, object) {
            this.parent(amount, object);
            ig.game.spawnEntity(EntityParticlesEmitter, this.pos.x, this.pos.y, { type: "blood", amount: 5 });
        },
        kill: function() {
